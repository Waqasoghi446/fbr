...
use App\Http\Controllers\FbrScenarioController;
use App\Http\Controllers\FbrTestController;
...
Route::prefix('fbr-scenarios')->group(function () {

    // Business Types Routes
    Route::get('/business-types', [FbrScenarioController::class, 'getBusinessTypes']);
    Route::get('/business-types-with-counts', [FbrScenarioController::class, 'getBusinessTypesWithCounts']);

    // Scenarios Routes
    Route::get('/by-business-type', [FbrScenarioController::class, 'getScenariosByBusinessType']);
    Route::get('/all-dropdown', [FbrScenarioController::class, 'getAllScenariosForDropdown']);
    Route::get('/dropdown-data', [FbrScenarioController::class, 'getDropdownData']);
    Route::get('/search', [FbrScenarioController::class, 'searchScenarios']);
    Route::get('/stats', [FbrScenarioController::class, 'getScenarioStats']);

    // Scenario Details Routes
    Route::get('/{scenarioCode}/sample-invoice', [FbrScenarioController::class, 'generateSampleInvoice']);
    Route::get('/{scenarioCode}', [FbrScenarioController::class, 'getScenarioDetails']);
});


Route::get('/fbr', [FbrTestController::class, 'test']);
Route::get('/SN001', [FbrTestController::class, 'SN001']);
Route::get('/SN002', [FbrTestController::class, 'SN002']);
Route::get('/SN003', [FbrTestController::class, 'SN003']);
Route::get('/SN004', [FbrTestController::class, 'SN004']);
Route::get('/SN005', [FbrTestController::class, 'SN005']);
Route::get('/SN006', [FbrTestController::class, 'SN006']);
Route::get('/SN007', [FbrTestController::class, 'SN007']);
Route::get('/SN008', [FbrTestController::class, 'SN008']);
Route::get('/SN009', [FbrTestController::class, 'SN009']);
Route::get('/SN010', [FbrTestController::class, 'SN010']);
Route::get('/SN011', [FbrTestController::class, 'SN011']);
Route::get('/SN012', [FbrTestController::class, 'SN012']);
Route::get('/SN013', [FbrTestController::class, 'SN013']);
Route::get('/SN014', [FbrTestController::class, 'SN014']);
Route::get('/SN015', [FbrTestController::class, 'SN015']);
Route::get('/SN016', [FbrTestController::class, 'SN016']);
Route::get('/SN017', [FbrTestController::class, 'SN017']);
Route::get('/SN018', [FbrTestController::class, 'SN018']);
Route::get('/SN019', [FbrTestController::class, 'SN019']);
Route::get('/SN020', [FbrTestController::class, 'SN020']);
Route::get('/SN021', [FbrTestController::class, 'SN021']);
Route::get('/SN022', [FbrTestController::class, 'SN022']);
Route::get('/SN023', [FbrTestController::class, 'SN023']);
Route::get('/SN024', [FbrTestController::class, 'SN024']);
Route::get('/SN025', [FbrTestController::class, 'SN025']);
Route::get('/SN026', [FbrTestController::class, 'SN026']);
Route::get('/SN027', [FbrTestController::class, 'SN027']);
